...
use vnclone\ImageMetaData\Format\JPEG;
use vnclone\ImageMetaData\Format\PNG;
use vnclone\ImageMetaData\Format\WebP;
 ...
 */
abstract class ImageMetaData implements ImageInterface
{
    /**
     * @var string
     */
